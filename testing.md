...
Current state: **475 tests, 29 files**, all green via `npm run test`.
...
| ------------------------------------------------------------------------ | ------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Exclusion engine (detectors, banlist matcher, auto-fix, check, describe) | `src/lib/exclusion/*.test.ts` (5)                            | Decides what gets flagged/rewritten in every draft                                                                                                                                                                                                |
